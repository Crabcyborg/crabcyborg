...
//		[corner_crawl.length]: 'corner_crawl'
	...
	let smallest = Math.min(
		...
		straight_smooth_x5.length, double.length, step2.length/*, step3.length, step4.length, corner_in.length, corner_out.length*//*, corner_crawl.length*/
	);
