...
var $author$project$Main$cellDecoder = A4(
...
var $author$project$Main$gridDecoder = $elm$json$Json$Decode$list($author$project$Main$cellDecoder);
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $elm$core$Debug$todo = _Debug_todo;
var $author$project$Main$init = function (flags) {
	var _v0 = A2($elm$json$Json$Decode$decodeValue, $author$project$Main$gridDecoder, flags.grid);
	if (_v0.$ === 'Ok') {
		var grid = _v0.a;
		return _Utils_Tuple2(
			{grid: grid, height: flags.height, width: flags.width},
...
var $author$project$Main$view = function (model) {
	return A2(
		...
		A2($elm$core$List$map, $author$project$Main$renderCell, model.grid));
};
			...
			return A2(
				...
				function (height) {
					return A2(
						...
						A2($elm$json$Json$Decode$field, 'grid', $elm$json$Json$Decode$value));
				},
