...
export const content = () => [
    ...
    m(Visualization, { method: t.pipe(t.horizontal, t.reposition, t.repeat(t.smooth('straight'), 2)) } ),
    m('h3', m(Descriptor, 'smooth (straight x6)')),
    m(Visualization, { method: t.pipe(t.horizontal, t.repeat(t.smooth('straight'), 6)) } ),
    m('h3', m(Descriptor, 'bounce + smooth (straight x5)')),
    m(Visualization, { method: t.pipe(t.horizontal, t.bounce, t.repeat(t.smooth('straight'), 5)) } ),
    m('h3', 'Smooth (x5)'),
    m(Visualization, { method: t.pipe(t.horizontal, t.repeat(t.smooth(), 5)) }),
    m('h3', 'Smooth (straight x5)'),
    m(Visualization, { method: t.pipe(t.horizontal, t.repeat(t.smooth('straight'), 5)) }),
    m('h3', m(Descriptor, 'diagonal + smooth (x3)')),
    m(Visualization, { method: t.pipe(t.diagonal, t.repeat(t.smooth(), 3)) }),
    m('h3', m(Descriptor, 'spiral + smooth (x2)')),
    m(Visualization, { method: t.pipe(t.spiral, t.repeat(t.smooth(), 2)) }),
    m('h3', m(Descriptor, 'diamond + smooth')),
    m(Visualization, { method: t.pipe(t.diamond, t.repeat(t.smooth(), 1)) }),
    m('h3', m(Descriptor, 'bounce + smooth (x4)')),
    m(Visualization, { method: t.pipe(t.horizontal, t.bounce, t.repeat(t.smooth(), 4)) }),
];