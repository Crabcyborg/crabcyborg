...
export var Home = {
	view: v => [
		...
		m('p', 'This entire website is open source (', m('a', { href: github, target: '_blank' }, github), '), webpacked, and hosted on Netlify for free, built on ', m('a', { href: 'https://mithril.js.org/' }, 'mithril.js.')),
