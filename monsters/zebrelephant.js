...
const legs = [
	{
		...
		style: {  maxWidth: '36px', bottom: '46px', left: '24px', transformOrigin: '20% 20%' },
		foot: {
	...
	},
	{
		...
		style: { maxWidth: '24px', bottom: '50px', left: '6px', zIndex: 3 },
		foot: {
			image: assets.ibis_foot_2,
			style: { bottom: '2px', left: '10px', transform: 'scale(1.8)' }
		}
	},
	{
		...
		foot: {
			...
			style: { bottom: '8px', left: '6px' }
		}
	},
	{
		image: assets.zebra_leg_4,
		style: { maxWidth: '40px', bottom: '38px', transform: 'rotate(-10deg)', right: '16px', zIndex: 4 },
		foot: {
